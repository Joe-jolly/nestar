...
export class MemberService {
    ...
    public async signup(input: MemberInput): Promise<Member> {
        ...
        try {
            ...
            throw new BadRequestException(Message.USER_MEMBER_NICK_OR_PHONE);
        }
    ...
    public async login(input: LoginInput): Promise<Member> {
        ...
        const tempPassword = response.memberPassword || '';
        const isMatch = await this.authService.comparePasswords(input.memberPassword, tempPassword);
    ...
    public async getMember(memberId: ObjectId, targetId: ObjectId): Promise<Member> {
        ...
        if (memberId) { 
            ...
            targetMember.meFollowed = await this.checkSubscription(memberId, targetId); // meFollowed
        }
